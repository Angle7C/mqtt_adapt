use mqtt::protocol::{MqttPacket, Packet, FixedHeader, PacketType};
use mqtt::protocol::{ConnectPacket, ConnAckPacket, PublishPacket, PubAckPacket, PubRecPacket, PubRelPacket, PubCompPacket, SubscribePacket, SubAckPacket, UnsubscribePacket, UnsubAckPacket, PingReqPacket, PingRespPacket, DisconnectPacket};
...
fn test_packet_serialization() {
    ...
    let connack_packet = ConnAckPacket {
        ...
        return_code: mqtt::protocol::ConnectReturnCode::Accepted,
    };
